resource "aws_iam_instance_profile" "beanstalk_service_eb" {
    name = "beanstalk-service-user_eb"
    role = aws_iam_role.beanstalk_service.name
}

resource "aws_iam_instance_profile" "beanstalk_ec2_eb" {
    name = "beanstalk-ec2-user_eb"
...
resource "aws_iam_policy_attachment" "beanstalk_service_eb" {
...
resource "null_resource" "setup_roles"{
  depends_on = [
    ...
    "aws_iam_instance_profile.beanstalk_service_eb",
    "aws_iam_policy_attachment.beanstalk_service_eb",
    "aws_iam_policy_attachment.beanstalk_service_health",
    "aws_iam_role.beanstalk_ec2",
    "aws_iam_instance_profile.beanstalk_ec2_eb",
